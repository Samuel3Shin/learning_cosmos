...
import UsernameMarsUsernameMarsMars from './username/mars/username.mars.mars'
...
export default { 
  ...
  UsernameMarsUsernameMarsMars: load(UsernameMarsUsernameMarsMars, 'username.mars.mars'),
